...
Only download CC Switch from **[ccswitch.io](https://ccswitch.io)**, **[GitHub Releases](https://github.com/Duojiyi/chimera-plusplus/releases)**, or the project source repository. Any "CC Switch" site or client that asks for payment, top-ups, or login credentials is not official.
...
1. Visit the [Releases page](https://github.com/Duojiyi/chimera-plusplus/releases)
