...
请只从 **[ccswitch.io](https://ccswitch.io)**、**[GitHub Releases](https://github.com/Duojiyi/chimera-plusplus/releases)** 或项目源码仓库获取 CC Switch。任何要求付费、充值或索取登录凭据的“CC Switch”网站或客户端都不是官方渠道。
...
1. 访问 [Releases 页面](https://github.com/Duojiyi/chimera-plusplus/releases)
