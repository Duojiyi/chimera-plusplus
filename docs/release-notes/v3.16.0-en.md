...
> 💡 Special thanks to [@EldenPdx](https://github.com/EldenPdx) for PR [#2804](https://github.com/Duojiyi/chimera-plusplus/pull/2804): this feature's Chat ↔ Responses format conversion references the implementation in his PR.
...
Visit [Releases](https://github.com/Duojiyi/chimera-plusplus/releases/latest) to download the appropriate version.
