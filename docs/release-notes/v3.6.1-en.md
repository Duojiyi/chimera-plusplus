...
**[中文更新说明 Chinese Documentation →](https://github.com/Duojiyi/chimera-plusplus/blob/main/docs/release-notes/v3.6.1-zh.md)**
...
- [中文文档 (Chinese)](https://github.com/Duojiyi/chimera-plusplus/blob/main/README_ZH.md)
- [English Documentation](https://github.com/Duojiyi/chimera-plusplus/blob/main/README.md)
- [完整更新日志 (Full Changelog)](https://github.com/Duojiyi/chimera-plusplus/blob/main/CHANGELOG.md)
...
**Full Changelog**: https://github.com/Duojiyi/chimera-plusplus/compare/v3.6.0...v3.6.1
...
**Project Repository**: https://github.com/Duojiyi/chimera-plusplus
