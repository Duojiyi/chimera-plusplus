...
[![Version](https://img.shields.io/github/v/release/Duojiyi/chimera-plusplus?color=blue&label=version)](https://github.com/Duojiyi/chimera-plusplus/releases)
[![Platform](https://img.shields.io/badge/platform-Windows%20%7C%20macOS%20%7C%20Linux-lightgrey.svg)](https://github.com/Duojiyi/chimera-plusplus/releases)
[![Built with Tauri](https://img.shields.io/badge/built%20with-Tauri%202-orange.svg)](https://tauri.app/)
[![Downloads](https://img.shields.io/github/downloads/Duojiyi/chimera-plusplus/total)](https://github.com/Duojiyi/chimera-plusplus/releases/latest)

<a href="https://trendshift.io/repositories/15372" target="_blank"><img src="https://trendshift.io/api/badge/repositories/15372" alt="farion1231%2Fcc-switch | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
<a href="https://www.star-history.com/#Duojiyi/chimera-plusplus&Date"><picture><source media="(prefers-color-scheme: dark)" srcset="https://api.star-history.com/badge?repo=Duojiyi/chimera-plusplus&theme=dark" /><img alt="Star History Rank" src="https://api.star-history.com/badge?repo=Duojiyi/chimera-plusplus" width="196" height="55" /></picture></a>
...
Wenn Sie über ein Desktop-Symbol starten, fügen Sie es der `Exec=`-Zeile der `.desktop`-Datei hinzu (z. B. `env CHIMERA_GDK_BACKEND=wayland /pfad/zum/AppImage`) oder setzen Sie es in Ihrer Sitzungsumgebung. Die Variable ist generisch: Auf Tiling-Wayland-Compositors (sway/Hyprland), bei denen Klicks nicht reagieren, versuchen Sie umgekehrt `CHIMERA_GDK_BACKEND=x11`. Bleibt sie ungesetzt, bleibt das Standardverhalten erhalten (der alte Variablenname `CC_SWITCH_GDK_BACKEND` funktioniert weiterhin).
...
- `Chimera++-v{version}-Linux-x86_64.AppImage` (universell)
...
[![Star History Chart](https://api.star-history.com/svg?repos=Duojiyi/chimera-plusplus&type=Date)](https://www.star-history.com/#Duojiyi/chimera-plusplus&Date)
